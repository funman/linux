/*
** $Id: proslic_spi_api.c,v 1.1.2.1 2012-03-06 13:01:48 kurtis Exp $
**
** spi.h
...
#include "../../slic_ctrl.h"
#define CONFIG_RALINK_PCM_SPICH	4
...
static uInt8 ReadReg (uInt16 portID, uInt8 channel, uInt8 regAddr){
	...
	SPI_bytes_read(CONFIG_RALINK_PCM_SPICH, regCtrl, regAddr, &retVal, 1);
	return retVal;
}
...
static void WriteReg (uInt16 portID, uInt8 channel, uInt8 regAddr, uInt8 data){
	...
	SPI_bytes_write(CONFIG_RALINK_PCM_SPICH, regCtrl, regAddr, &data, 1);
}
...
int SPI_Init (ctrl_S *hSpi){
	...
	SPI_cfg(CONFIG_RALINK_PCM_SPICH);
	i = 0;
	return (!i);
}
...
** Revision 1.1.2.1  2012-03-06 13:01:48  kurtis
** remove rt63365 keyword to rt6855A
**
** Revision 1.1  2011-11-14 07:54:35  qwert
