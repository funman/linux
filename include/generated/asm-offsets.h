...
#define TASK_MM 184 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 216 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STRUCT_SIZE 1104 /* sizeof(struct task_struct)	 # */
...
#define THREAD_BVADDR 844 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 848 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 852 /* offsetof(struct task_struct, thread.error_code)	 # */
#define THREAD_TRAMP 856 /* offsetof(struct task_struct, thread.irix_trampoline)	 # */
#define THREAD_OLDCTX 860 /* offsetof(struct task_struct, thread.irix_oldctx)	 # */
